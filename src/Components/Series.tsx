...
const Series = () => {
  ...
  useEffect(() => {
    ...
    // top series today
    getGenres();
    URL[6] = "https://api.themoviedb.org/3/trending/tv/day?language=en-US";
    handleFetch(99);

    // trending
    URL[0] = "https://api.themoviedb.org/3/trending/tv/week?language=en-US";
    handleFetch(0);

    //  highest rated all - higest rated
    URL[1] =
      "https://api.themoviedb.org/3/discover/tv?include_adult=false&include_video=false&language=en-US&sort_by=vote_average.desc&vote_count.gte=200&with_original_language=en" +
      (selectedGenre !== 2
    ...
    URL[2] =
      "https://api.themoviedb.org/3/discover/tv?include_adult=false&include_video=false&language=en-US&sort_by=" +
      (selectedGenre !== 2 ? "popularity.desc" : "vote_average.desc") +
      "&vote_count.gte=200&with_genres=" +
      (selectedGenre !== 2 ? selectedGenre.toString() : "10759") +
      "&with_original_language=en";
    handleFetch(2);

    // best in Comedy - new releases
    URL[3] =
      "https://api.themoviedb.org/3/discover/tv?include_adult=false&include_video=false&language=en-US&sort_by=vote_average.desc&vote_count.gte=200&with_genres=35&with_original_language=en";
    handleFetch(3);

    // best documentaries
    URL[4] =
      "https://api.themoviedb.org/3/discover/tv?include_adult=false&include_video=false&language=en-US&sort_by=vote_average.desc&vote_count.gte=200&with_genres=99&with_original_language=en";
    handleFetch(4);

    // best in Animation
    URL[5] =
      "https://api.themoviedb.org/3/discover/tv?include_adult=false&include_video=false&language=en-US&sort_by=vote_average.desc&vote_count.gte=200&with_genres=16&with_original_language=en";
    handleFetch(5);
    URL[8] =
      "https://api.themoviedb.org/3/discover/tv?include_adult=false&include_video=false&language=en-US&sort_by=vote_average.desc&vote_count.gte=200&with_genres=10762&with_original_language=en";
    handleFetch(8);
    URL[9] =
      "https://api.themoviedb.org/3/discover/tv?include_adult=false&include_video=false&language=en-US&sort_by=vote_average.desc&vote_count.gte=20&with_genres=10763&with_original_language=en";
    handleFetch(9);
    //new releases
    URL[7] =
      "https://api.themoviedb.org/3/discover/tv?include_adult=false&include_video=false&language=en-US&sort_by=primary_release_date.desc&vote_count.gte=3&with_original_language=en" +
      (selectedGenre !== 2
        ? "&with_genres=" + selectedGenre.toString()
        : "&with_genres=");
    handleFetch(7);
      ...
      <section className="s1 d-flex flex-column align-items-center ">
        ...
        <div className="s2 position-relative d-flex flex-column align-items-center">
          ...
          <div className="media-list-container col-11">
            ...
            <GenreList genres={tvGenres} handleGenre={handleGenre} />
            ...
            {selectedGenre === 2 ? (
              <div>
                ...
                <MediaList
                  ...
                  handleLoad={handleLoad}
                />
                <h3 className="mt-5 text">Best for kids</h3>
                <MediaList
                  typeofmedia="tv"
                  media={mediaList8}
                  genres={tvGenres ? tvGenres : []}
                  ...
                  handleLoad={handleLoad}
                />
                <h3 className="mt-5 text">Best in News</h3>
                <MediaList
                  typeofmedia="tv"
                  media={mediaList9}
                  genres={tvGenres ? tvGenres : []}
